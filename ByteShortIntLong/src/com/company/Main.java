...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        long myLongChallenge = 50000 + 10 * (myIntChallenge + myByteChallenge + myShortChallenge);
        System.out.println(myLongChallenge);

        short myShortTest = (short) (1000 + 10 + (myIntChallenge + myByteChallenge + myShortChallenge));
